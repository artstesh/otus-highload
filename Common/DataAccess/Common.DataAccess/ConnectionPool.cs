...
public class ConnectionPool
{
    ...
    public async Task<PoolEntity> GetConnection(string connectionString)
    {
        ...
        {
            return poolEntity.Connection.FullState != ConnectionState.Open ? await GetConnection(connectionString) : poolEntity;
        }
